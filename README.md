...
> - [Onboarding guide](docs/getting-started/onboarding.md) — zero-to-hero with a realistic end-to-end walkthrough
> - [TDD workflow deep dive](docs/concepts/tdd-server.md) — how `vizzly tdd` actually works
> - [Playwright integration](docs/guides/playwright-integration.md), [Jest integration](docs/guides/jest-integration.md), [CI/CD setup](docs/guides/ci-cd-integration.md)
>
> The docs that ship with the original repo are [`docs/browser-flags.md`](docs/browser-flags.md) and [`docs/json-output.md`](docs/json-output.md). Everything else in `docs/` was written for this tutorial fork.
